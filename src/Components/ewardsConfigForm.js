...
const EwardsConfigForm = (props) => {
    ...
    const updateFormData =  ()  =>  {
        ...
        axios.put(
           `${baseUrl}/api/ewards-key/${configId}`,data
         )  .then(function (response) {
        console.log("response",response)
     ...
     const handleDelete =  ()  =>  {
        ...
        axios.delete(
           `${baseUrl}/api/ewards-key/${configId}`
         )  .then(function (response) {
            setFormData((prevData) => ({...prevData,merchant_id:localStorage.merchantId,
                customerKey:"",
                xApiKey:"",
    ...
    useEffect(()=>{
        ...
        axios.get(
            `${baseUrl}/api/ewards-key/?store_url=${window.location.origin}`
        ).then(function (response) {
            ...
            <div className="container px-5">
                ...
                <div className="card border-secondary mb-3 ps-0 pe-0" style={cardWidth}>
                        ...
                        <div className="card-footer bg-transparent border-secondary text-end">
                            {!isEdit && (<button type="submit" className="btn btn-primary" onClick={addFormData}
                                style={buttonStyle}
                ...
                <div className="modal-dialog">
                    ...
                    <div className="modal-header">
                        <h5 className="modal-title" id="staticBackdropLabel">Delete Confoguration</h5>
